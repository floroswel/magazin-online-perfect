...
const mockVendors: Record<string, any> = {
  "mama-lucica": {
    ...
    description: "Magazin oficial cu cele mai bune produse la prețuri accesibile. Livrare rapidă în toată România.",
    rating: 4.8,
    reviewCount: 2340,
    productCount: 156,
    responseRate: "98%",
    ...
    joinedDate: "2022",
    badges: ["Vendor de încredere", "Livrare rapidă", "Top Seller"],
    policies: {
      shipping: "Livrare gratuită pentru comenzi peste 200 lei. Livrare standard: 1-3 zile lucrătoare.",
      returns: "Retur gratuit în 30 de zile de la primire. Produsul trebuie să fie în starea originală.",
      warranty: "Garanție 24 luni pentru toate produsele electronice.",
    },
  },
};
