      ...
      <div className="container py-10 md:py-16 px-5">
        ...
        <div className="border-t border-primary-foreground/20 mt-12 pt-8">
          <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-1">
            ...
            <div ref={footerScriptsRef} className="flex flex-row flex-wrap items-center gap-2 [&_a]:inline-flex [&_a]:text-[10px] [&_a]:text-primary-foreground/50 [&_a]:hover:text-primary-foreground/80 [&_a]:transition-colors [&_img]:h-5 [&_img]:!w-auto [&_img]:object-contain [&_img]:opacity-60 [&_img]:hover:opacity-90 [&_span]:text-[10px] [&_span]:text-primary-foreground/50 [&_p]:text-[10px] [&_p]:text-primary-foreground/50 [&>div]:flex [&>div]:flex-row [&>div]:items-center [&>div]:gap-2 [&_div]:!display-none [&_div]:contents" />
          </div>
        </div>
      </div>
    </footer>
