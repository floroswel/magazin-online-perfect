      ...
      <Dialog open={campaignOpen} onOpenChange={setCampaignOpen}>
        <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div><Label className="text-xs">Sender name</Label><Input value={cf.sender_name} onChange={e => setCf({ ...cf, sender_name: e.target.value })} placeholder="MegaShop" /></div>
              <div><Label className="text-xs">Sender email</Label><Input value={cf.sender_email} onChange={e => setCf({ ...cf, sender_email: e.target.value })} placeholder="news@megashop.ro" /></div>
            </div>
            <div className="grid grid-cols-2 gap-3">
              <div>
