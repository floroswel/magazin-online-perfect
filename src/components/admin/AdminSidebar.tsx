    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Bannere & Popups", path: "/admin/marketing/banners", dividerBefore: "Campanii" },
          { label: "Manager Popups", path: "/admin/marketing/popups" },
          ...
          { label: "Feed-uri Produse", path: "/admin/marketing/feeds", dividerBefore: "Distribuție" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Redirecturi SEO", path: "/admin/seo/redirects", dividerBefore: "SEO" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Footer", path: "/admin/settings/footer", dividerBefore: "Navigare" },
          { label: "Breadcrumbs", path: "/admin/settings/breadcrumbs" },
          { label: "Ticker Bars", path: "/admin/settings/ticker" },
      ...
      },
      {
        ...
        children: [
          ...
          { label: "System Health", path: "/admin/system/health", dividerBefore: "Monitorizare" },
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Facturare", path: "/admin/settings/invoices", dividerBefore: "Plăți & Taxe" },
