    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Centru Vizibilitate", path: "/admin/control" },
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Allegro", path: "/admin/channels/allegro", dividerBefore: "Canale Vânzare" },
          { label: "OLX", path: "/admin/channels/olx" },
          { label: "Tracking & Pixeli", path: "/admin/marketing/pixels", dividerBefore: "Tracking" },
          { label: "Curieri AWB", path: "/admin/shipping/carriers", dividerBefore: "Livrare" },
          { label: "Facturare SmartBill", path: "/admin/settings/smartbill" },
          { label: "Newsletter / Email", path: "/admin/settings/email", dividerBefore: "Comunicare" },
