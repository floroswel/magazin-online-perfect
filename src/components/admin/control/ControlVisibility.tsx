...
const DEFAULT_ELEMENTS: Omit<VisibilityRow, "id" | "updated_at" | "updated_by">[] = [
  ...
  { element_key: "section_why_mamalucica", is_active: true, category: "sections", label: "De Ce MamaLucica", path_label: "Homepage > Why", scheduled_from: null, scheduled_until: null },
