        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="flex items-start gap-2">
            ...
            <label htmlFor="popup-consent" className="text-xs text-muted-foreground cursor-pointer">
              Sunt de acord să primesc emailuri promoționale. Citește <Link to="/politica-de-confidentialitate" className="text-primary hover:underline">Politica de Confidențialitate</Link>. Mă pot dezabona oricând.
            </label>
          </div>
