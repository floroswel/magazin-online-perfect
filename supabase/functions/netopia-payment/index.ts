...
Deno.serve(async (req: Request) => {
  ...
  // GET = diagnostic test call to Netopia V2 sandbox
  if (req.method === "GET") {
    try {
      const apiKey = Deno.env.get("NETOPIA_API_KEY") || "";
      console.log("TEST: apiKey present:", !!apiKey, "length:", apiKey.length, "first10:", apiKey.substring(0, 10));
      ...
      const testResponse = await fetch(
        "https://secure.sandbox.netopia-payments.com/payment/card/start",
        {
          ...
          body: JSON.stringify({
            ...
            order: {
              ntpID: "",
              posSignature: "3BBD-XEHU-UYUY-4VLV-UQPW",
