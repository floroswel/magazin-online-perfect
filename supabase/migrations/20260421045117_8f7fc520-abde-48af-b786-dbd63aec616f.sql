...
AS $$
  SELECT (
    ...
    OR _key LIKE 'theme_text_%'
    OR _key LIKE 'theme_%'
    OR _key LIKE 'hero_%'
    OR _key LIKE 'benefit_%'
    OR _key LIKE 'mid_banner_%'
    OR _key LIKE 'navbar_special_%'
    OR _key LIKE 'megamenu_%'
    OR _key LIKE 'popup_%'
    OR _key LIKE 'newsletter_%'
    OR _key = ANY (
      ARRAY[
        ...
        'categories_title','flash_deals_title',
        ...
        'search_border_color','badge_hot_color'
      ]
    )
  );
$$;